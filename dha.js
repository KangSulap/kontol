...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya DpinV2,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 DpinV2`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`Ngapain dibaca?\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt DpinV2\n Helpme tu 1k subscriber', imageMessage: imageMsg,
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`DpinV2 ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN DpinV2」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
case 'tahta':
         ...
         break    
case 'pornhub':
         if (args.length == 0) return reply(`Contoh: ${prefix + command} DpinV2`)
         txt1 = args[0]
         txt2 = args[1]
