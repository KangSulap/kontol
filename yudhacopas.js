...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color('[SOURCE CODE INI GW REMAKE AWOKAOWK\n\n', 'orange'), color('\n======TERIMKASIH BANYAK KEPADA======\n•Allah Swt \n•Tuhan Yesus aowkaowk \n•IKYADS\n•Terima kasih buat lu semua ngntd\n•Pak Jokowi\n•Kang Remake\n•Penyedia Kondom\n•Apa Lo Tega\n•KONTOL/n•Ini cuma remake doang kok', 'yellow'))
	console.log(color('\n\nJANGAN DI BUAT COLI BRO😑\nKALAU ADA YG PENGEN COLI SURUH CHAT ©BapaGw😅\nWA DEVIN 6285694982557😗', 'pink'))
...
const spinner = { 
  ...
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ Gw Ganteng ]', 'purple'), color('BOT SUDAH AKTIF SELAMAT MENGGUNAKAN'));
	})
